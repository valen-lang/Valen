---
name: slice-start-check-supervised
description: Verify that slice-start correctly inserted mig slice comments above all Scala definitions
tools: [Read, Grep, Glob, Task]
model: haiku
---

Please run the /slice-start-check agent on the file you were pointed at.

Your goal is to clean up and doublecheck the results given to you by the /slice-start-check agent.

Below are the guidelines it's checking for. and whats Can you please correct its output and then give it to me?
...
Produce a corrected report, with:
