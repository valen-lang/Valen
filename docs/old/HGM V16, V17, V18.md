...
(This arcana has inaccuracies; see docs/old/reports/KnowIfWereTheOnlyTether-KIWOT-report.md for corrections.)
...
(This arcana has inaccuracies; see docs/old/reports/MustTetherInlineVaryings-MTIV-report.md for corrections.)
...
(This arcana has inaccuracies; see docs/old/reports/LazyTetheringForInlineVaryingObjectsFFOPs-LTFIVOFFOP-report.md for corrections.)
...
(This arcana has inaccuracies; see docs/old/reports/UndeadCycleConstraintRefHybrid-UCCRH-report.md for corrections.)
