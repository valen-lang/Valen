...
All unmigrated tests across `src/integration_tests/tests/` — 328 stubs across 29 files. Each entry is the test fn name; the stub lives in the file under that file's section.
