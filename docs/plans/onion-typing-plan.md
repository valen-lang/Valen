...
**Files:** `src/typing/types/types.rs`, `src/typing/typing_interner.rs`, `src/typing/templata/templata.rs`.
...
**Files:** `src/lexing/*`, `src/parsing/templex_parser.rs`, `src/parsing/expression_parser.rs`, `src/postparsing/*`, `src/keywords.rs`, plus ~13 weak fixtures + any `weak`-as-identifier fixtures + any `Ref`-as-rune-type fixtures.
...
**Files:** `src/postparsing/rules/rules.rs`, `src/postparsing/rules/rule_scout.rs`, `src/typing/infer/compiler_solver.rs`, `src/typing/macros/anonymous_interface_macro.rs`, `src/typing/infer_compiler.rs`, `src/typing/edge_compiler.rs`.
...
**Files:** `src/typing/templata/templata.rs`, `src/typing/rune_type_solver.rs`, `src/postparsing/ast.rs`. (Formerly also `src/higher_typing/*` — since retired outright.)
...
**Files:** `src/typing/templata_compiler.rs`, `src/instantiating/instantiator.rs`, `src/instantiating/ast/*`.
...
**Files:** `src/hammer/type_hammer.rs`, `src/hammer/load_hammer.rs`, `src/hammer/struct_hammer.rs`, `src/simplifying/expression_hammer.rs`, `src/final_ast/types.rs`, `src/final_ast/ast.rs`, `src/final_ast/instructions.rs`, `src/testvm/*`, `src/backend_ffi/metal_lowerer.rs`.
...
**Files:** `src/typing/convert_helper.rs`, `src/typing/expression/expression_compiler.rs`, `src/typing/expression/local_helper.rs`, `src/typing/pattern_compiler.rs`.
...
- `docs/shields/TypesFitIntoTheseCategories-TFITCX.md` — add four new ref-variant categories.
