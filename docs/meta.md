...
Docs live next to the code they describe. Project-wide concerns live in `Sylvan/docs/` or `docs/`. Pass-specific concerns live in that pass's `docs/` directory.
...
```
docs/usage/build-test.md  (g_auto_load_when_editing: [src/**/*.rs])
