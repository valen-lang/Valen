...
parse_sample_test!(parse_sample_127, "programs/structs/bigstructmutfield.vale");
parse_sample_test!(parse_sample_128, "programs/structs/structmut.vale");
parse_sample_test!(parse_sample_129, "programs/structs/structmutfield.vale");
...
parse_sample_test!(parse_sample_145, "programs/arrays/inlssamut.vale");
