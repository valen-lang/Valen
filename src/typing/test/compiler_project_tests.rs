...
fn function_has_correct_name() {
  ...
  let code_source = CodeSource::new(vec![new_test_code_map_from_files(
    &parse_arena,
  ...
  let id = {
    ...
    let main_template_name = typing_interner.intern_function_template_name(FunctionTemplateNameT {
      human_name: scout_arena.intern_str("main"),
      code_location: main_loc,
    });
    let main_name = typing_interner.intern_function_name(FunctionNameValT {
...
fn lambda_has_correct_name() {
  ...
  let lambda_func_id = {
    ...
    let lambda_citizen_template_name =
      typing_interner.intern_lambda_citizen_template_name(LambdaCitizenTemplateNameT {
        code_location: lambda_loc,
      });
    let lambda_citizen_name = typing_interner
      .intern_lambda_citizen_name(LambdaCitizenNameT { template: lambda_citizen_template_name });
    ...
    let lambda_func_name =
      typing_interner.intern_lambda_call_function_name(LambdaCallFunctionNameValT {
