...
use crate::typing::ast::expressions::{
  ...
  StaticSizedArrayLookupTE, UnletTE, UpcastInterfaceTE, VoidLiteralTE, WhileTE,
};
  ...
  's: 't,
{
  ...
  match e {
    ...
    ExpressionTE::UpcastInterface(x) => visit_upcast_interface(pred, out, x),
...
fn visit_upcast_interface<'s, 't, T, F>(pred: &F, out: &mut Vec<T>, x: &'t UpcastInterfaceTE<'s, 't>)
where
  F: Fn(NodeRefT<'s, 't>) -> Option<T>,
  's: 't,
{
