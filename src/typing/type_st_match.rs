...
use crate::postparsing::ast::{ParameterS, LocationInDenizen};
...
where 's: 't,
{
    ...
    pub fn compute_upcast_coerced_arg(
        ...
        let expected_template_id = self.param_expected_value_type_template(
            coutputs, calling_env, call_range_t, call_location, context_region, param)?;
        ...
        self.get_parents(coutputs, call_range_t, call_location, calling_env, arg_sub_kind)
            .into_iter()
            .find(|s| matches!(s, ISuperKindTT::Interface(_))
