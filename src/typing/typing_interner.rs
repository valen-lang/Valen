  ...
  's: 't,
{
  ...
  fn alloc_name_canonical<'tmp>(
    ...
    match val {
      ...
      V::ImplBound(v) => {
        let template_args = self.bump.alloc_slice_copy(v.template_args);
        let canonical =
          ImplBoundNameT { template: v.template, template_args, _must_intern: MustIntern(()) };
      ...
      V::OverrideDispatcher(v) => {
        ...
        let canonical = OverrideDispatcherNameT {
          template: v.template,
          template_args,
          parameters,
          _must_intern: MustIntern(()),
      ...
      V::OverrideDispatcherCase(v) => {
        let independent_impl_template_args =
          self.bump.alloc_slice_copy(v.independent_impl_template_args);
        let canonical = OverrideDispatcherCaseNameT {
          independent_impl_template_args,
          _must_intern: MustIntern(()),
        };
      ...
      V::ExternFunction(v) => {
        let template_args = self.bump.alloc_slice_copy(v.template_args);
        let parameters = self.bump.alloc_slice_copy(v.parameters);
        let canonical = ExternFunctionNameT {
      ...
      V::FunctionBound(v) => {
        let template_args = self.bump.alloc_slice_copy(v.template_args);
        let parameters = self.bump.alloc_slice_copy(v.parameters);
        let canonical = FunctionBoundNameT {
          template: v.template,
          template_args,
          parameters,
          _must_intern: MustIntern(()),
      ...
      V::PredictedFunction(v) => {
        let template_args = self.bump.alloc_slice_copy(v.template_args);
        let parameters = self.bump.alloc_slice_copy(v.parameters);
        let canonical = PredictedFunctionNameT {
          template: v.template,
          template_args,
          parameters,
          _must_intern: MustIntern(()),
      ...
      V::LambdaCallFunctionTemplate(v) => {
        ...
        let canonical = LambdaCallFunctionTemplateNameT {
          code_location: v.code_location,
          param_types,
          _must_intern: MustIntern(()),
        };
        let key =
          LambdaCallFunctionTemplateNameValT { code_location: v.code_location, param_types };
        (
          V::LambdaCallFunctionTemplate(key),
          T::LambdaCallFunctionTemplate(self.bump.alloc(canonical)),
        )
      }
      V::LambdaCallFunction(v) => {
        let template_args = self.bump.alloc_slice_copy(v.template_args);
        let parameters = self.bump.alloc_slice_copy(v.parameters);
        let canonical = LambdaCallFunctionNameT {
          template: v.template,
          template_args,
          parameters,
          _must_intern: MustIntern(()),
      ...
      V::Struct(v) => {
        let template_args = self.bump.alloc_slice_copy(v.template_args);
        let canonical =
          StructNameT { template: v.template, template_args, _must_intern: MustIntern(()) };
      ...
      V::Interface(v) => {
        let template_args = self.bump.alloc_slice_copy(v.template_args);
        let canonical =
          InterfaceNameT { template: v.template, template_args, _must_intern: MustIntern(()) };
      ...
      V::AnonymousSubstructImpl(v) => {
        let template_args = self.bump.alloc_slice_copy(v.template_args);
        let canonical = AnonymousSubstructImplNameT {
          template: v.template,
          template_args,
          sub_citizen: v.sub_citizen,
          _must_intern: MustIntern(()),
        };
        let key = AnonymousSubstructImplNameValT {
          template: v.template,
          template_args,
          sub_citizen: v.sub_citizen,
        };
      ...
      V::AnonymousSubstructConstructor(v) => {
        let template_args = self.bump.alloc_slice_copy(v.template_args);
        let parameters = self.bump.alloc_slice_copy(v.parameters);
        let canonical = AnonymousSubstructConstructorNameT {
          template: v.template,
          template_args,
          parameters,
          _must_intern: MustIntern(()),
        ...
        let key =
          AnonymousSubstructConstructorNameValT { template: v.template, template_args, parameters };
        (
          V::AnonymousSubstructConstructor(key),
          T::AnonymousSubstructConstructor(self.bump.alloc(canonical)),
        )
      }
      V::AnonymousSubstruct(v) => {
        let template_args = self.bump.alloc_slice_copy(v.template_args);
        let canonical = AnonymousSubstructNameT {
          template: v.template,
          template_args,
          _must_intern: MustIntern(()),
        };
      ...
      V::InterfaceTemplate(p) => {
        (V::InterfaceTemplate(p), T::InterfaceTemplate(self.bump.alloc(p)))
      }
      V::AnonymousSubstructImplTemplate(p) => (
        V::AnonymousSubstructImplTemplate(p),
        T::AnonymousSubstructImplTemplate(self.bump.alloc(p)),
      ),
      V::AnonymousSubstructTemplate(p) => {
        (V::AnonymousSubstructTemplate(p), T::AnonymousSubstructTemplate(self.bump.alloc(p)))
      }
      V::AnonymousSubstructConstructorTemplate(p) => (
        V::AnonymousSubstructConstructorTemplate(p),
        T::AnonymousSubstructConstructorTemplate(self.bump.alloc(p)),
      ),
  ...
  pub fn intern_id<'tmp>(&self, val: IdValT<'s, 't, 'tmp>) -> &'t IdT<'s, 't> {
    ...
    let stored_key =
      IdValT { package_coord: val.package_coord, init_steps, local_name: val.local_name };
    let mut inner = self.inner.borrow_mut();
  ...
  pub fn intern_prototype<'tmp>(&self, val: PrototypeValT<'s, 't, 'tmp>) -> &'t PrototypeT<'s, 't> {
    ...
    let canonical: &'t PrototypeT<'s, 't> =
      self.bump.alloc(PrototypeT { id: *id_ref, return_type: val.return_type });
  ...
  impl_intern_name_wrapper_transient!(
    intern_override_dispatcher_name,
    OverrideDispatcher,
    OverrideDispatcherNameValT,
    OverrideDispatcherNameT
  );
  impl_intern_name_wrapper_transient!(
    intern_override_dispatcher_case_name,
    OverrideDispatcherCase,
    OverrideDispatcherCaseNameValT,
    OverrideDispatcherCaseNameT
  );
  impl_intern_name_wrapper_transient!(
    intern_extern_function_name,
    ExternFunction,
  ...
  impl_intern_name_wrapper_transient!(
    intern_function_bound_name,
    FunctionBound,
    FunctionBoundNameValT,
    FunctionBoundNameT
  );
  impl_intern_name_wrapper_transient!(
    intern_predicted_function_name,
    PredictedFunction,
    PredictedFunctionNameValT,
    PredictedFunctionNameT
  );
  impl_intern_name_wrapper_transient!(
    intern_lambda_call_function_template_name,
    LambdaCallFunctionTemplate,
    LambdaCallFunctionTemplateNameValT,
    LambdaCallFunctionTemplateNameT
  );
  impl_intern_name_wrapper_transient!(
    intern_lambda_call_function_name,
    LambdaCallFunction,
  ...
  impl_intern_name_wrapper_transient!(
    ...
    AnonymousSubstructImpl,
    AnonymousSubstructImplNameValT,
    AnonymousSubstructImplNameT
  );
  impl_intern_name_wrapper_transient!(
    intern_anonymous_substruct_constructor_name,
    AnonymousSubstructConstructor,
    AnonymousSubstructConstructorNameValT,
    AnonymousSubstructConstructorNameT
  );
  impl_intern_name_wrapper_transient!(
    intern_anonymous_substruct_name,
    AnonymousSubstruct,
  ...
  impl_intern_name_wrapper_simple_s_only!(
    intern_impl_template_name,
    ImplTemplate,
    ImplTemplateNameT
  );
  impl_intern_name_wrapper_simple_s_only!(
    intern_impl_bound_template_name,
    ImplBoundTemplate,
    ImplBoundTemplateNameT
  );
  ...
  impl_intern_name_wrapper_simple_none!(
    intern_reachable_prototype_name,
    ReachablePrototype,
    ReachablePrototypeNameT
  );
  impl_intern_name_wrapper_simple_none!(
    intern_static_sized_array_template_name,
  ...
  impl_intern_name_wrapper_simple_none!(
    intern_runtime_sized_array_template_name,
    RuntimeSizedArrayTemplate,
    RuntimeSizedArrayTemplateNameT
  );
  impl_intern_name_wrapper_simple!(
    intern_runtime_sized_array_name,
    RuntimeSizedArray,
    RuntimeSizedArrayNameT
  );
  impl_intern_name_wrapper_simple_s_only!(
    intern_kind_placeholder_template_name,
    KindPlaceholderTemplate,
    KindPlaceholderTemplateNameT
  );
  impl_intern_name_wrapper_simple!(
    intern_kind_placeholder_name,
    KindPlaceholder,
    KindPlaceholderNameT
  );
  impl_intern_name_wrapper_simple_s_only!(
    intern_non_kind_non_region_placeholder_name,
    NonKindNonRegionPlaceholder,
    NonKindNonRegionPlaceholderNameT
  );
  impl_intern_name_wrapper_simple!(
    intern_override_dispatcher_template_name,
    OverrideDispatcherTemplate,
    OverrideDispatcherTemplateNameT
  );
  ...
  impl_intern_name_wrapper_simple_t_only!(
    intern_typing_pass_temporary_var_name,
  ...
  impl_intern_name_wrapper_simple_s_only!(
    intern_struct_template_name,
    StructTemplate,
    StructTemplateNameT
  );
  impl_intern_name_wrapper_simple_s_only!(
    intern_interface_template_name,
    InterfaceTemplate,
    InterfaceTemplateNameT
  );
  impl_intern_name_wrapper_simple!(
    intern_anonymous_substruct_impl_template_name,
    AnonymousSubstructImplTemplate,
    AnonymousSubstructImplTemplateNameT
  );
  impl_intern_name_wrapper_simple!(
    intern_anonymous_substruct_template_name,
    AnonymousSubstructTemplate,
    AnonymousSubstructTemplateNameT
  );
  impl_intern_name_wrapper_simple!(
    intern_anonymous_substruct_constructor_template_name,
  ...
  impl_intern_kind_wrapper!(
    intern_runtime_sized_array_tt,
    RuntimeSizedArrayTT,
    RuntimeSizedArrayTTValT,
    RuntimeSizedArrayTT
  );
  impl_intern_kind_wrapper!(
    intern_kind_placeholder,
    KindPlaceholder,
    KindPlaceholderT,
    KindPlaceholderT
  );
