...
use crate::postparsing::names::{CodeNameS, CodeVarNameS, IVarDeclarationNameS};
...
fn regular_variable() {
  ...
  match local {
    LocalS {
      var_name: IVarDeclarationNameS::CodeVarName(CodeVarNameS { imprecise_name: CodeNameS { name: StrI("x"), .. }, .. }),
