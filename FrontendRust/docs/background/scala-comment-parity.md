...
// V: make sure that document skill is aware that these background docs should be very very concise, and have references out to docs it can look at for more information