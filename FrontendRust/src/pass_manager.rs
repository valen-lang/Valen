...
use crate::parsing::ast::PackageCoordinate;
...
pub fn resolve_package_contents(
    ...
    _package_coord: &PackageCoordinate,
...
pub trait IFrontendInput {
    fn package_coord(&self, interner: Arc<Mutex<Interner>>) -> PackageCoordinate;
}
...
impl IFrontendInput for SourceInput {
    fn package_coord(&self, _interner: Arc<Mutex<Interner>>) -> PackageCoordinate {
