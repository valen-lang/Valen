...
impl ParseError {
    ...
    pub fn error_id(&self) -> &'static str {
        match self {
            ...
            ParseError::BadExpressionEnd(_) | ParseError::BadRule(_) |
            ParseError::UnexpectedAttributes(_) | ParseError::IfBlocksMustBothOrNeitherReturn(_) |
            ParseError::BadExpressionBegin(_) | ParseError::BadStringChar { .. } |
            ParseError::BadFunctionName(_) | ParseError::BadParamEnd(_) |
            ParseError::ForgotSetKeyword(_) | ParseError::BadBinaryFunctionName(_) |
            ParseError::BadTemplateCallee(_) | ParseError::UnknownTupleOrSubExpression(_) |
            ParseError::BadRangeOperand(_) | ParseError::CantUseBreakInExpression(_) |
            ParseError::CantUseReturnInExpression(_) | ParseError::CantUseWhileInExpression(_) |
            ParseError::NeedSemicolon(_) | ParseError::DontNeedSemicolon(_) |
            ParseError::BadDot(_) | ParseError::CantTemplateCallMember(_) => "P1005",
            ...
            ParseError::BadUnicodeChar(_) | ParseError::BadStringInterpolationEnd(_) |
            ParseError::BadStartOfBlock(_) | ParseError::BadEndOfBlock(_) |
            ...
            ParseError::BadStructName(_) | ParseError::BadInterfaceName(_) |
            ParseError::BadStructContentsBegin(_) | ParseError::BadStructContentsEnd(_) |
            ParseError::BadStructMember(_) | ParseError::BadStructMemberType(_) |
            ParseError::VariadicStructMemberHasName(_) | ParseError::BadInterfaceMember(_) |
            ParseError::BadInterfaceContentsBegin(_) => "P1027",
            ParseError::BadInterfaceHeader(_) => "P1028",
            ParseError::BadImpl(_) | ParseError::BadImplStruct(_) |
            ParseError::BadImplInterface(_) | ParseError::BadImplEnd(_) |
            ParseError::BadImplFor(_) | ParseError::BadExportAs(_) => "P1029",
            ParseError::BadImportEnd(_) | ParseError::BadImportName(_) => "P1031",
            ParseError::BadFunctionParamsBegin(_) | ParseError::BadFunctionAfterParam(_) |
            ParseError::BadAttributeError(_) | ParseError::BadExternAttribute(_) => "P1032",
            ParseError::BadExportName(_) | ParseError::BadExportEnd(_) |
            ParseError::BadForeachIterableError(_) => "P1037",
            ParseError::BadArraySpecifier(_) => "P1039",
            ParseError::BadLocalName(_) | ParseError::BadThingAfterTypeInPattern(_) |
