...
pub enum INameS {
  ...
  ImplDeclaration(Arc<ImplDeclarationNameS>),
  ExportAsName(Arc<ExportAsNameS>),
  TopLevelStructDeclaration(Arc<TopLevelStructDeclarationNameS>),
  TopLevelInterfaceDeclaration(Arc<TopLevelInterfaceDeclarationNameS>),
  VarName(IVarNameS),
}
...
*/
#[derive(Clone, Debug, PartialEq, Eq, Hash)]
pub struct TopLevelCitizenDeclarationNameS {
  pub name: Arc<StrI>,
  pub range: RangeS,
}

pub type TopLevelStructDeclarationNameS = TopLevelCitizenDeclarationNameS;
pub type TopLevelInterfaceDeclarationNameS = TopLevelCitizenDeclarationNameS;
...
pub enum IRuneS {
  CodeRune(CodeRuneS),
  DenizenDefaultRegionRune(DenizenDefaultRegionRuneS),
}
