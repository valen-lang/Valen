...
//
// H-side output types for the simplifying pass. Most of this file is the
// wrapped Scala source; the Rust definitions below are the minimum subset
// referenced by src/simplifying/conversions.rs. Expand each via the slice-
// pipeline as JR's migration touches the corresponding Scala type.
/*
...
pub struct CodeLocation {
    pub file: (),  // TBD: FileCoordinate stub — fill in when finalast/FileCoordinate is scaffolded
    pub offset: i32,
}
