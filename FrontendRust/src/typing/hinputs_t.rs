...
pub fn make<'s, 't>(
    ...
    _rune_to_bound_impl: Vec<(crate::postparsing::names::IRuneS<'s>, crate::typing::names::names::IdT<'s, 't, &'t crate::typing::names::names::IImplNameT<'s, 't>>)>,
...
pub struct InstantiationBoundArgumentsT<'s, 't> {
    ...
    pub rune_to_bound_impl: Vec<(
        crate::postparsing::names::IRuneS<'s>,
        crate::typing::names::names::IdT<'s, 't, &'t crate::typing::names::names::IImplNameT<'s, 't>>,
    )>,
}
/*
...
pub struct HinputsT<'s, 't> {
    ...
    pub interface_to_edge_blueprints: std::collections::HashMap<
        crate::typing::names::names::IdT<'s, 't, &'t crate::typing::names::names::IInterfaceNameT<'s, 't>>,
        crate::typing::ast::ast::InterfaceEdgeBlueprintT<'s, 't>,
    >,
    pub interface_to_sub_citizen_to_edge: std::collections::HashMap<
        crate::typing::names::names::IdT<'s, 't, &'t crate::typing::names::names::IInterfaceNameT<'s, 't>>,
        std::collections::HashMap<crate::typing::names::names::IdT<'s, 't, &'t crate::typing::names::names::ICitizenNameT<'s, 't>>, crate::typing::ast::ast::EdgeT<'s, 't>>,
    >,

    pub instantiation_name_to_instantiation_bounds: std::collections::HashMap<
        crate::typing::names::names::IdT<'s, 't, &'t crate::typing::names::names::IInstantiationNameT<'s, 't>>,
        InstantiationBoundArgumentsT<'s, 't>,
    >,
    ...
    pub sub_citizen_to_interface_to_edge: std::collections::HashMap<
        crate::typing::names::names::IdT<'s, 't, &'t crate::typing::names::names::ICitizenNameT<'s, 't>>,
        std::collections::HashMap<crate::typing::names::names::IdT<'s, 't, &'t crate::typing::names::names::IInterfaceNameT<'s, 't>>, crate::typing::ast::ast::EdgeT<'s, 't>>,
    >,
}
/*
case class HinputsT(
