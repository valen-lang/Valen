...
*/
pub struct LockWeakTE<'s, 't> { pub inner_expr: ReferenceExpressionTE<'s, 't>, pub result_opt_borrow_type: CoordT<'s, 't>, pub some_constructor: PrototypeT<'s, 't, IFunctionNameT<'s, 't>>, pub none_constructor: PrototypeT<'s, 't, IFunctionNameT<'s, 't>>, pub some_impl_name: IdT<'s, 't,IImplNameT<'s, 't>>, pub none_impl_name: IdT<'s, 't,IImplNameT<'s, 't>> }
...
*/
pub struct UpcastTE<'s, 't> { pub inner_expr: ReferenceExpressionTE<'s, 't>, pub target_super_kind: ISuperKindTT<'s, 't>, pub impl_name: IdT<'s, 't,IImplNameT<'s, 't>> }
