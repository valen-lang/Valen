...
impl FunctionBodyMacro {
    ...
    where 's: 't,
    {
        match self {
            ...
            FunctionBodyMacro::RsaNew => Ok(compiler.generate_function_body_rsa_new(coutputs, env, generator_id, life, call_range, call_location, origin_function, param_coords, maybe_ret_coord)),
            ...
            FunctionBodyMacro::RsaCapacity => Ok(compiler.generate_function_body_rsa_capacity(coutputs, env, generator_id, life, call_range, call_location, origin_function, param_coords, maybe_ret_coord)),
            FunctionBodyMacro::RsaPop => Ok(compiler.generate_function_body_rsa_pop(coutputs, env, generator_id, life, call_range, call_location, origin_function, param_coords, maybe_ret_coord)),
            FunctionBodyMacro::RsaPush => Ok(compiler.generate_function_body_rsa_push(coutputs, env, generator_id, life, call_range, call_location, origin_function, param_coords, maybe_ret_coord)),
