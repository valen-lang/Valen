...
fn simple_lambda() {
    ...
    let expected = CoordT::new(OwnershipT::Own, RegionT { region: RegionT::Default }, KindT::Int(IntT { bits: 32 }));
...
fn lambda_with_one_magic_arg() {
    ...
    assert_eq!(
        ...
        CoordT::new(OwnershipT::Own, RegionT { region: RegionT::Default }, KindT::Int(IntT { bits: 32 })),
    );
}
