...
where 's: 'h, 'h: 'v,
{
    ...
    match name.as_str() {
        ...
        "__vbi_modI32" => Box::new(crate::testvm::vivem_externs::mod_i32),
        ...
        "__vbi_lessThanFloat" => Box::new(crate::testvm::vivem_externs::less_than_float),
        ...
        "__vbi_not" => Box::new(crate::testvm::vivem_externs::not),
